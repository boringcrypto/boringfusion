...
map = ModelMap({
    ...
    "97dd98b1": ModelDataInfo(
        ...
        "",
        "",
        ['bf_fb_v3_t4_b16_noadd-ema-pruned-fp16.ckpt', 'bondage3_24000.ckpt', 'bukkake_20_training_images_2020_max_training_steps_woman_class_word.ckpt', 'Cyberpunk-Anime-Diffusion.ckpt', 'DCAUV1.ckpt', 'easter_e5.ckpt', 'furry_epoch4.ckpt', 'gape22_yiffy15.ckpt', 'Hiten girl_anime_8k_wallpaper_4k.ckpt', 'last-pruned.ckpt', 'LD-70k-1e-pruned.ckpt', 'Lewd-diffusion-pruned.ckpt', 'pyros-bj-v1-0.ckpt', 'r34_e4.ckpt', 'trinart2_step115000.ckpt', 'trinart2_step60000.ckpt', 'trinart2_step95000.ckpt', 'trinart_characters_it4_v1.ckpt', 'wd-v1-3-float16.ckpt', 'yiffy-e18.ckpt', 'Zack3D_Kinky-v1.ckpt', 'sd-wikiart-v2', 'cafe-instagram-unofficial-test-epoch-9-140k-images-fp32.ckpt', 'arcane-diffusion-5k.ckpt', 'arcane-diffusion-v2.ckpt', 'arcane-diffusion-v3.ckpt', 'eldenring-v1-pruned.ckpt', 'MirrorsEdge.ckpt'],
    ),
    ...
    "75335bbc": ModelDataInfo(
        ...
        "https://huggingface.co/stabilityai/sd-vae-ft-mse-original/resolve/main/vae-ft-mse-840000-ema-pruned.ckpt",
        "This VAE was resumed from the 1.5 EMA decoder and uses EMA weights and was trained for another 280k steps using a different loss, with more emphasis on MSE reconstruction (MSE + 0.1 * LPIPS). It produces somewhat ``smoother'' outputs.",
        ['classicAnim-v1.ckpt', 'moDi-v1-pruned.ckpt', 'eldenring-v2-pruned.ckpt', 'eldenRing-v3-pruned.ckpt', 'mdjrny-v4.ckpt', 'redshift-diffusion-v1.ckpt', 'Tron-Legacy-Style-trnlgcy.ckpt'],
    ),
