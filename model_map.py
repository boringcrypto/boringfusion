...
map = ModelMap({
    ...
    "62ab9f03": ModelDataInfo(
        ...
        ['pachu_artwork_style_v1_iter8000.ckpt', 'SF_EB_1.0_ema_vae.ckpt', 'vae-ft-mse-840000-ema-pruned.ckpt', 'Dungeons-diffusion-model16000.ckpt', 'Dungeons-diffusion-model30000.ckpt'],
    ),
