...
map = ModelMap({
    ...
    "97dd98b1": ModelDataInfo(
        ...
        "",
        "",
        ['bf_fb_v3_t4_b16_noadd-ema-pruned-fp16.ckpt', 'bondage3_24000.ckpt', 'bukkake_20_training_images_2020_max_training_steps_woman_class_word.ckpt', 'Cyberpunk-Anime-Diffusion.ckpt', 'DCAUV1.ckpt', 'easter_e5.ckpt', 'furry_epoch4.ckpt', 'gape22_yiffy15.ckpt', 'Hiten girl_anime_8k_wallpaper_4k.ckpt', 'last-pruned.ckpt', 'LD-70k-1e-pruned.ckpt', 'Lewd-diffusion-pruned.ckpt', 'pyros-bj-v1-0.ckpt', 'r34_e4.ckpt', 'trinart2_step115000.ckpt', 'trinart2_step60000.ckpt', 'trinart2_step95000.ckpt', 'trinart_characters_it4_v1.ckpt', 'wd-v1-3-float16.ckpt', 'yiffy-e18.ckpt', 'Zack3D_Kinky-v1.ckpt', 'sd-wikiart-v2', 'cafe-instagram-unofficial-test-epoch-9-140k-images-fp32.ckpt', 'arcane-diffusion-5k.ckpt', 'arcane-diffusion-v2.ckpt', 'arcane-diffusion-v3.ckpt', 'eldenring-v1-pruned.ckpt', 'MirrorsEdge.ckpt', 'archer-v1.ckpt'],
    ),
    ...
    "7da99596": ModelDataInfo(
        ...
        ['stable-diffusion-v1-4', 'Taiyi-Stable-Diffusion-1B-Chinese-v0.1', 'sd-v1-4-full-ema.ckpt', 'sd-v1-4.ckpt', 'stable-diffusion_v1-4.ckpt'],
    ),
    "8d39156d": ModelDataInfo(
        ...
        ['v1-5-pruned-emaonly.ckpt', 'v1-5-pruned.ckpt', 'stable-diffusion_v1-5-pruned-emaonly.ckpt'],
    ),
    ...
    "62ab9f03": ModelDataInfo(
        ...
        ['pachu_artwork_style_v1_iter8000.ckpt', 'SF_EB_1.0_ema_vae.ckpt', 'vae-ft-mse-840000-ema-pruned.ckpt', 'Dungeons-diffusion-model16000.ckpt', 'Dungeons-diffusion-model30000.ckpt', 'stable-diffusion_v2-0_768-v-ema.ckpt', 'stable-diffusion_v2-1_512-ema-pruned.ckpt', 'stable-diffusion_v2-1_768-ema-pruned.ckpt', 'stable-diffusion_vae-ft-mse-840000-ema-pruned.ckpt', '512-base-ema.ckpt', '512-depth-ema.ckpt', '512-inpainting-ema.ckpt', '768-v-ema.ckpt', 'v2-1_512-ema-pruned.ckpt', 'v2-1_512-nonema-pruned.ckpt', 'v2-1_768-ema-pruned.ckpt', 'v2-1_768-nonema-pruned.ckpt'],
    ),
    ...
    "75335bbc": ModelDataInfo(
        ...
        "https://huggingface.co/stabilityai/sd-vae-ft-mse-original/resolve/main/vae-ft-mse-840000-ema-pruned.ckpt",
        "This VAE was resumed from the 1.5 EMA decoder and uses EMA weights and was trained for another 280k steps using a different loss, with more emphasis on MSE reconstruction (MSE + 0.1 * LPIPS). It produces somewhat ``smoother'' outputs.",
        ['classicAnim-v1.ckpt', 'moDi-v1-pruned.ckpt', 'eldenring-v2-pruned.ckpt', 'eldenRing-v3-pruned.ckpt', 'mdjrny-v4.ckpt', 'redshift-diffusion-v1.ckpt', 'Tron-Legacy-Style-trnlgcy.ckpt', 'comic-diffusion-V2.ckpt', 'comic-diffusion.ckpt'],
    ),
    ...
    "4a57995c": ModelDataInfo(
        "",
        "CLIP Encoder",
        "mdjrny-v4.ckpt",
        "data/clip-text-encoder/4a57995c-4a57995c.bin",
        "4a57995c",
        "4a57995c",
        "torch.float16",
        "123060557",
    ...
    "92b1dc9f": ModelDataInfo(
        "",
        "UNet",
        "mdjrny-v4.ckpt",
        "data/unet/92b1dc9f-92b1dc9f.bin",
        "92b1dc9f",
        "92b1dc9f",
        "torch.float16",
        "859520964",
    ...
    "b155d0de": ModelDataInfo(
        "",
        "CLIP Encoder",
        "MirrorsEdge.ckpt",
        "data/clip-text-encoder/b155d0de-b155d0de.bin",
        "b155d0de",
        "b155d0de",
        "torch.float16",
        "123060557",
    ...
    "ea3b9ccf": ModelDataInfo(
        "",
        "UNet",
        "MirrorsEdge.ckpt",
        "data/unet/ea3b9ccf-ea3b9ccf.bin",
        "ea3b9ccf",
        "ea3b9ccf",
        "torch.float16",
        "859520964",
    ...
    "2a83478a": ModelDataInfo(
        "",
        "CLIP Encoder",
        "redshift-diffusion-v1.ckpt",
        "data/clip-text-encoder/2a83478a-2a83478a.bin",
        "2a83478a",
        "2a83478a",
        "torch.float16",
        "123060557",
    ...
    "f549a480": ModelDataInfo(
        "",
        "UNet",
        "redshift-diffusion-v1.ckpt",
        "data/unet/f549a480-f549a480.bin",
        "f549a480",
        "f549a480",
        "torch.float16",
        "859520964",
    ...
    "01b2192a": ModelDataInfo(
        "",
        "CLIP Encoder",
        "Tron-Legacy-Style-trnlgcy.ckpt",
        "data/clip-text-encoder/01b2192a-01b2192a.bin",
        "01b2192a",
        "01b2192a",
        "torch.float16",
        "123060557",
    ...
    "5aa517ef": ModelDataInfo(
        "",
        "UNet",
        "Tron-Legacy-Style-trnlgcy.ckpt",
        "data/unet/5aa517ef-5aa517ef.bin",
        "5aa517ef",
        "5aa517ef",
        "torch.float16",
        "859520964",
    ...
    "829b4ec7": ModelDataInfo(
        "",
        "VAE Encoder",
        "Anything-V3.0.vae.pt",
        "data/vae-encoder/262eb8ae-829b4ec7.bin",
        "262eb8ae",
        "829b4ec7",
        "torch.float32",
        "34163664",
    ...
    "0b118c3c": ModelDataInfo(
        "",
        "VAE Decoder",
        "Anything-V3.0.vae.pt",
        "data/vae-decoder/9806f0d2-0b118c3c.bin",
        "9806f0d2",
        "0b118c3c",
        "torch.float32",
        "49490199",
    ...
    "66fa033a": ModelDataInfo(
        "",
        "CLIP Encoder",
        "archer-v1.ckpt",
        "data/clip-text-encoder/66fa033a-66fa033a.bin",
        "66fa033a",
        "66fa033a",
        "torch.float16",
        "123060557",
    ...
    "33b372a8": ModelDataInfo(
        "",
        "UNet",
        "archer-v1.ckpt",
        "data/unet/33b372a8-33b372a8.bin",
        "33b372a8",
        "33b372a8",
        "torch.float16",
        "859520964",
    ...
    "16d3c802": ModelDataInfo(
        "",
        "CLIP Encoder",
        "comic-diffusion-V2.ckpt",
        "data/clip-text-encoder/16d3c802-16d3c802.bin",
        "16d3c802",
        "16d3c802",
        "torch.float16",
        "123060557",
    ...
    "87227765": ModelDataInfo(
        "",
        "UNet",
        "comic-diffusion-V2.ckpt",
        "data/unet/87227765-87227765.bin",
        "87227765",
        "87227765",
        "torch.float16",
        "859520964",
    ...
    "3fb034c9": ModelDataInfo(
        "",
        "CLIP Encoder",
        "comic-diffusion.ckpt",
        "data/clip-text-encoder/3fb034c9-3fb034c9.bin",
        "3fb034c9",
        "3fb034c9",
        "torch.float16",
        "123060557",
    ...
    "22546400": ModelDataInfo(
        "",
        "UNet",
        "comic-diffusion.ckpt",
        "data/unet/22546400-22546400.bin",
        "22546400",
        "22546400",
        "torch.float16",
        "859520964",
    ...
    "85bc7d78": ModelDataInfo(
        "",
        "CLIP Encoder",
        "Dungeons-diffusion-model16000.ckpt",
        "data/clip-text-encoder/33b4bab0-85bc7d78.bin",
        "33b4bab0",
        "85bc7d78",
    ...
    "18d680b0": ModelDataInfo(
        "",
        "UNet",
        "Dungeons-diffusion-model16000.ckpt",
        "data/unet/3fe250b7-18d680b0.bin",
        "3fe250b7",
        "18d680b0",
        "torch.float32",
        "859520964",
    ...
    "4d547473": ModelDataInfo(
        "",
        "CLIP Encoder",
        "Dungeons-diffusion-model30000.ckpt",
        "data/clip-text-encoder/994b1cdd-4d547473.bin",
        "994b1cdd",
        "4d547473",
        "torch.int64, torch.float32",
        "123060557",
    ...
    "a3a4b057": ModelDataInfo(
        "",
        "UNet",
        "Dungeons-diffusion-model30000.ckpt",
        "data/unet/d91b0bd0-a3a4b057.bin",
        "d91b0bd0",
        "a3a4b057",
        "torch.float32",
        "859520964",
    ...
    "518b440f": ModelDataInfo(
        "",
        "CLIP Encoder",
        "PaperCut_v1.ckpt",
        "data/clip-text-encoder/bfd68d64-518b440f.bin",
        "bfd68d64",
        "518b440f",
        "torch.int64, torch.float32",
        "123060557",
    ...
    "69bb807d": ModelDataInfo(
        "",
        "UNet",
        "PaperCut_v1.ckpt",
        "data/unet/4af10375-69bb807d.bin",
        "4af10375",
        "69bb807d",
        "torch.float32",
        "859520964",
    ...
    "79e9c54b": ModelDataInfo(
        "",
        "VAE Encoder",
        "stable-diffusion-x4-upscaler-ema.ckpt",
        "data/vae-encoder/dfb52e20-79e9c54b.bin",
        "dfb52e20",
        "79e9c54b",
        "torch.float32",
        "72",
        ...
        "",
        "",
        ['stable-diffusion-x4-upscaler-ema.ckpt', 'x4-upscaler-ema.ckpt'],
    ),
    "31b4d5ba": ModelDataInfo(
        "",
        "VAE Decoder",
        "stable-diffusion-x4-upscaler-ema.ckpt",
        "data/vae-decoder/42977e75-31b4d5ba.bin",
        "42977e75",
        "31b4d5ba",
        "torch.float32",
        "20",
    ...
    "8d97b3c9": ModelDataInfo(
        "",
        "UNet",
        "stable-diffusion_v2-0_768-v-ema.ckpt",
        "data/unet/038fa086-8d97b3c9.bin",
        "038fa086",
        "8d97b3c9",
        "torch.float32",
        "865910724",
        ...
        "",
        "",
        ['stable-diffusion_v2-0_768-v-ema.ckpt', '768-v-ema.ckpt'],
    ),
    "f0a7e4ef": ModelDataInfo(
        "",
        "UNet",
        "stable-diffusion_v2-1_512-ema-pruned.ckpt",
        "data/unet/fd94f0dc-f0a7e4ef.bin",
        "fd94f0dc",
        "f0a7e4ef",
        "torch.float32",
        "865910724",
        ...
        "",
        "",
        ['stable-diffusion_v2-1_512-ema-pruned.ckpt', 'v2-1_512-ema-pruned.ckpt'],
    ),
    "59a8260b": ModelDataInfo(
        "",
        "UNet",
        "stable-diffusion_v2-1_768-ema-pruned.ckpt",
        "data/unet/fc12f995-59a8260b.bin",
        "fc12f995",
        "59a8260b",
        "torch.float32",
        "865910724",
        ...
        "",
        "",
        ['stable-diffusion_v2-1_768-ema-pruned.ckpt', 'v2-1_768-ema-pruned.ckpt'],
    ),
    "29d6065c": ModelDataInfo(
        "",
        "UNet",
        "sd512-base-ema.ckpt",
        "data/unet/9f4b0393-29d6065c.bin",
        "9f4b0393",
        "29d6065c",
        "torch.float32",
        "865910724",
    ...
    "76bf40ed": ModelDataInfo(
        "",
        "UNet",
        "sd512-depth-ema.ckpt",
        "data/unet/37e297de-76bf40ed.bin",
        "37e297de",
        "76bf40ed",
        "torch.float32",
        "865913604",
    ...
    "2efe1312": ModelDataInfo(
        "",
        "UNet",
        "sd512-inpainting-ema.ckpt",
        "data/unet/472f4c2f-2efe1312.bin",
        "472f4c2f",
        "2efe1312",
        "torch.float32",
        "865925124",
    ...
    "ef6fc293": ModelDataInfo(
        "",
        "UNet",
        "v2-1_512-nonema-pruned.ckpt",
        "data/unet/4072c3cb-ef6fc293.bin",
        "4072c3cb",
        "ef6fc293",
        "torch.float32",
        "865910724",
    ...
    "f97f43c2": ModelDataInfo(
        "",
        "UNet",
        "v2-1_768-nonema-pruned.ckpt",
        "data/unet/b5378dbe-f97f43c2.bin",
        "b5378dbe",
        "f97f43c2",
        "torch.float32",
        "865910724",
