...
from core.modules.stable_diffusion_v2 import StableDiffusionV2
...
def main():
    ...
    model = StableDiffusionV2(models.unet.stable_diffusion_v2_1_768_ema_pruned_ckpt, "v", True, 1024, True)
